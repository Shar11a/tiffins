...
exports.createCheckoutSession = functions.https.onCall(async (data, context) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: 'payment',
      success_url: `${functions.config().app.url || 'https://tiffinbox-app.web.app'}/success?session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `${functions.config().app.url || 'https://tiffinbox-app.web.app'}/subscription`,
